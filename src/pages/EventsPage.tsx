  ...
  const events: EventItem[] = [
    {
      ...
      details: 'PRISMA`25 adalah kompetisi matematika tingkat nasional yang diadakan oleh Universitas Muhammadiyah Makassar. Kompetisi ini memberikan kesempatan bagi siswa untuk menguji kemampuan matematika mereka dalam berbagai kategori, termasuk aljabar, geometri, dan kalkulus. MOSAEC STELK berpartisipasi aktif dalam kompetisi ini sebagai bagian dari program pengembangan bakat matematika siswa.',
    ...
    },
    {
      ...
      details: 'MAC (MOSAEC: Calculation Project) adalah proyek pembelajaran yang menggabungkan konsep matematika dengan pemrograman. Peserta belajar membuat kalkulator fungsional menggunakan berbagai bahasa pemrograman, mulai dari Python hingga JavaScript. Proyek ini tidak hanya meningkatkan pemahaman matematika, tetapi juga memperkenalkan siswa pada dunia pemrograman dan teknologi.',
